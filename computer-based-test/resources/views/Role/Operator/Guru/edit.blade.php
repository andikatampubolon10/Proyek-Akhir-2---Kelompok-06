                ...
                <div class="w-full">
                    <form action="{{ route('Operator.Guru.update', $gurus->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input name="nip" value="{{($gurus->nip)}}" type="text" class="block w-full p-2 border border-black rounded-md">
                        </div>
                        <div class="mb-4">
                            <label class="block font-bold mb-2">Nama Guru</label>
                            <input name="name" value="{{ ($gurus->name) }}" type="text" class="block w-full p-2 border border-black rounded-md">
                        </div>
                        <div class="mb-4">
                            <label class="block font-bold mb-2">Password</label>
                            <input name="password" type="password" class="block w-full p-2 border border-black rounded-md">
                        </div>
                        <div class="mb-4">
