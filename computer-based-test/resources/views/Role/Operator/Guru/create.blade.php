...
<head>
    ...
    <title>Operator | Create Guru</title>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md h-full w-full">
                <form action="{{ route('Operator.Guru.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" maxlength="20" pattern="\d{20}" name="nip" class="block w-full p-2 border border-gray-300 rounded-md" required>
                    </div>
                    <div class="mb-4">
