...
<head>
    ...
    <title>Operator | Edit Kurikulum</title>
...
<body>
 ...
 <nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-white p-4 rounded-lg shadow-md flex items-center gap-2 mt-8 mb-6">
        ...
        <li class="breadcrumb-item active text-gray-600" aria-current="page">Edit Kurikulum</li>
    </ol>
</nav>
            <form action="{{ route('Operator.Kurikulum.update', $kurikulum->id_kurikulum) }}" method="POST">
                ...
                <div class="space-y-4 bg-white p-6 rounded-lg shadow-md">
                    <div>
                        ...
                        <input type="text" id="nama_kurikulum" name="nama_kurikulum" value="{{ $kurikulum->nama_kurikulum }}" class="mt-1 block w-full border border-gray-300 rounded-md p-2">
                    </div>
