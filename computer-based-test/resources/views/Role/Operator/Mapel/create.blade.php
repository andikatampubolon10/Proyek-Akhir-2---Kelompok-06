...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-white p-4 rounded-lg shadow-md flex items-center gap-2 mt-8 mb-6">
        <li class="breadcrumb-item">
            <a href="{{ route('Operator.MataPelajaran.store') }}" class="text-teal-500 hover:text-teal-700 font-semibold">Mata Pelajaran</a>
        </li>
        <li class="breadcrumb-item active text-gray-600" aria-current="page">Tambah Mata Pelajaran</li>
    </ol>
</nav>
            ...
            <div class="space-y-4">
                <form action="{{ route('Operator.MataPelajaran.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input name="nama_mata_pelajaran" type="text" class="mt-1 block w-full border border-gray-300 rounded p-2">
                    </div>
