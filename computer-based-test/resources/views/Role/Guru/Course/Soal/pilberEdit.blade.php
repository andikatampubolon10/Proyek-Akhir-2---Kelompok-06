        ...
        <div class="w-full md:w-3/4 p-4">
            <form action="{{ route('Guru.Soal.update', $soal->id_soal) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="border p-2">
                    ...
                    <textarea name="soal" class="w-full border p-2" rows="4" required>{{ $soal->soal }}</textarea>
                    <div id="image-preview" class="mt-2">
                        @if ($soal->image)
                            <img src="{{ asset('storage/'.$soal->image) }}" alt="Image Preview" style="max-width: 100%; height: auto;">
                        @endif
                    </div>
                </div>
                ...
                <div class="border p-2 mb-4">
                    ...
                    <textarea name="jawaban_1" placeholder="Jawaban 1" class="w-full border p-2" rows="2" required>{{ $soal->jawaban_soal[0]->jawaban ?? '' }}</textarea>
                    <div id="image-preview-1" class="mt-2"></div>
                </div>
                ...
                <div class="border p-2 mb-4">
                    ...
                    <textarea name="jawaban_2" placeholder="Jawaban 2" class="w-full border p-2" rows="2" required>{{ $soal->jawaban_soal[1]->jawaban ?? '' }}</textarea>
                    <div id="image-preview-2" class="mt-2"></div>
                </div>
                ...
                <div class="border p-2 mb-4">
                    ...
                    <textarea name="jawaban_3" placeholder="Jawaban 3" class="w-full border p-2" rows="2" required>{{ $soal->jawaban_soal[2]->jawaban ?? '' }}</textarea>
                    <div id="image-preview-3" class="mt-2"></div>
                </div>
                ...
                <div class="border p-2 mb-4">
                    ...
                    <textarea name="jawaban_4" placeholder="Jawaban 4" class="w-full border p-2" rows="2" required>{{ $soal->jawaban_soal[3]->jawaban ?? '' }}</textarea>
                    <div id="image-preview-4" class="mt-2"></div>
                </div>
                ...
                <div class="border p-2 mb-4">
                    ...
                    <textarea name="jawaban_5" placeholder="Jawaban 5" class="w-full border p-2" rows="2" required>{{ $soal->jawaban_soal[4]->jawaban ?? '' }}</textarea>
                    <div id="image-preview-5" class="mt-2"></div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select id="correct_answer" name="correct_answer" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="jawaban_1" {{ old('correct_answer', $soal->correct_answer) == 'jawaban_1' ? 'selected' : '' }}>Jawaban 1</option>
                        <option value="jawaban_2" {{ old('correct_answer', $soal->correct_answer) == 'jawaban_2' ? 'selected' : '' }}>Jawaban 2</option>
                        <option value="jawaban_3" {{ old('correct_answer', $soal->correct_answer) == 'jawaban_3' ? 'selected' : '' }}>Jawaban 3</option>
                        <option value="jawaban_4" {{ old('correct_answer', $soal->correct_answer) == 'jawaban_4' ? 'selected' : '' }}>Jawaban 4</option>
                        <option value="jawaban_5" {{ old('correct_answer', $soal->correct_answer) == 'jawaban_5' ? 'selected' : '' }}>Jawaban 5</option>
                    </select>
                </div>
