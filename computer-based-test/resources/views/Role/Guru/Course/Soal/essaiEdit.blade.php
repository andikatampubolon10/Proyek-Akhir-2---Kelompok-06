        ...
        <div class="bg-white p-6 rounded-lg shadow-md h-full w-full">
            <form action="{{ route('Guru.Soal.update', $soal->id_soal) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="border p-2 mb-4">
                    ...
                    <textarea name="jawaban_1" placeholder="Jawaban Essay" class="w-full border p-2" rows="4" required>{{ $soal->jawaban_soal[0]->jawaban ?? '' }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="correct_answer" name="correct_answer" class="w-full border p-2" rows="2" required>{{ $soal->correct_answer }}</textarea>
                </div>
