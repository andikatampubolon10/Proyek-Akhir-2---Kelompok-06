            ...
            <form action="{{ route('Guru.Soal.update', $soal->id_soal) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="border p-2">
                    ...
                    <div id="image-preview" class="mt-2">
                        @if ($soal->image)
                            <img src="{{ asset('storage/' . $soal->image) }}" alt="Image Preview"
                ...
                <div class="border p-2 mb-4">
                    ...
                    <textarea name="jawaban_1" placeholder="Jawaban 1 (True)" class="w-full border p-2" rows="2" required>{{ $soal->jawaban_soal[0]->jawaban ?? '' }}</textarea>
                ...
                <div class="border p-2 mb-4">
                    ...
                    <textarea name="jawaban_2" placeholder="Jawaban 2 (False)" class="w-full border p-2" rows="2" required>{{ $soal->jawaban_soal[1]->jawaban ?? '' }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <select id="correct_answer" name="correct_answer"
                        ...
                        <option value="jawaban_1"
                            {{ old('correct_answer', $soal->correct_answer) == 'jawaban_1' ? 'selected' : '' }}>True
                        </option>
                        <option value="jawaban_2"
                            {{ old('correct_answer', $soal->correct_answer) == 'jawaban_2' ? 'selected' : '' }}>False
                        </option>
                    </select>
                </div>
