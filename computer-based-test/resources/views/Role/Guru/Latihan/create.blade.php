        ...
        <div class="bg-white p-6 rounded-lg shadow-md h-full w-full">
            <form action="{{ route('Guru.Latihan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="Topik" class="block w-full p-2 border border-gray-300 rounded-md" required>
                </div>
            
                <div class="mb-4">
                    <label for="id_kurikulum" class="block font-bold mb-2">Pilih Kurikulum</label>
                    <select name="id_kurikulum" class="block w-full p-2 border border-gray-300 rounded-md" required>
                ...
                <div class="mb-4">
                    ...
                    <select name="id_mata_pelajaran" class="block w-full p-2 border border-gray-300 rounded-md" required>
