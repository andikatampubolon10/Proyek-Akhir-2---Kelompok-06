        ...
        <form action="{{ route('Guru.Persentase.store') }}" method="POST" class="space-y-6 w-full">
            ...
            <div class="flex flex-col space-y-6 w-full">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full">
                    ...
                    <input type="number" id="persentase_kuis" name="persentase_kuis" placeholder="20" required class="w-full sm:max-w-xs px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-right" placeholder="0 - 100">
                </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full">
                    ...
                    <input type="number" id="persentase_UTS" name="persentase_UTS" placeholder="40" required class="w-full sm:max-w-xs px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-right" placeholder="0 - 100">
                </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full">
                    ...
                    <input type="number" id="persentase_UAS" name="persentase_UAS" placeholder="40" required class="w-full sm:max-w-xs px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-right" placeholder="0 - 100">
                </div>
            </div>
