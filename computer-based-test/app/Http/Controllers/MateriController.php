...
class MateriController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('Role.Guru.Course.Materi.index', compact('materi', 'materi_pertama', 'user', 'kursus', 'id_kursus', 'courses', 'id_materi'));
    }
    ...
    public function edit(Request $request, $id_materi)
    {
        ...
        // Mengambil semua kursus yang terkait dengan guru
        ...
        // Menampilkan view dengan data materi, guru, id_kursus, dan kursus
