...
<body class="bg-gray-100">
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="flex-1 p-4">
            ...
            <h1 class="text-lg font-bold mb-4">Informasi Kelas</h1>
            <div class="space-y-4">
                <div class="bg-gray-300 p-4 rounded flex justify-between items-center">
                    <span class="text-lg text-gray-700">Kelas 7</span>
                    <a href="#" class="text-gray-500 flex items-center">
                        <i class="fas fa-pen mr-1"></i> EDIT
                    </a>
                </div>
                <div class="bg-gray-300 p-4 rounded flex justify-between items-center">
                    <span class="text-lg text-gray-700">Kelas 8</span>
                    <a href="#" class="text-gray-500 flex items-center">
                        <i class="fas fa-pen mr-1"></i> EDIT
                    </a>
                </div>
                <div class="bg-gray-300 p-4 rounded flex justify-between items-center">
                    <span class="text-lg text-gray-700">Kelas 9</span>
                    <a href="#" class="text-gray-500 flex items-center">
                        <i class="fas fa-pen mr-1"></i> EDIT
                    </a>
                </div>
