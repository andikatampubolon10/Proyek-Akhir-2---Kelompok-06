        ...
        <div class="flex-1 p-4">
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" class="mt-1 block w-full border border-black rounded p-2">
                </div>
                <div class="flex justify-end mt-8">
                    <button class="flex items-center bg-green-600 text-white font-bold py-2 px-4 rounded">
