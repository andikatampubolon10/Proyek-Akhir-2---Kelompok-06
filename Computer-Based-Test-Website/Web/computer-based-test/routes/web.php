...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('Admin')->name('Admin.')->group(function(){
        Route::resource('/Akun', OperatorController::class)->middleware('role:Admin');
    ...
    Route::prefix('Siswa')->name('Siswa.')->group(function(){
        ...
        Route::resource('/JawabanSoalUjian', JawabanSoalUjianController::class)->middleware('role:Siswa');
        Route::resource('/LatihanSoal', LatihanSoalController::class)->middleware('role:Siswa');
        Route::resource('/JawabanLatihanSoal', JawabanLatihanSoalController::class)->middleware('role:Siswa');
