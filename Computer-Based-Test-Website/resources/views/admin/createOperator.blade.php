...
<div class="flex">
    ...
    <div class="w-3/4 p-8">
        <div class="flex justify-between items-center mb-8">
            <div class="text-2xl font-bold text-blue-600">Tambah Operator</div>
        ...
        <form action="{{ route('admin.listOperator') }}" method="POST" class="space-y-6">
            @csrf
            <div>
                ...
                <input class="w-full border border-gray-400 p-2 rounded" type="text" name="sekolah" required>
            </div>
            ...
            <div>
                ...
                <input class="w-full border border-gray-400 p-2 rounded" type="text" name="username" required>
            </div>
            ...
            <div>
                ...
                <input class="w-full border border-gray-400 p-2 rounded" type="password" name="password" required>
            </div>
            ...
            <div>
                ...
                <input class="w-full border border-gray-400 p-2 rounded" type="password" name="password_confirmation" required>
            </div>
            ...
            <div>
                ...
                <input class="w-full border border-gray-400 p-2 rounded" type="number" name="duration" value="12" required>
            </div>
        ...
        document.getElementById("operatorForm").addEventListener("submit", function(event) {
            ...
            .then(response => {
                if (response.ok) {
                    window.location.href = "{{ route('admin.listOperator') }}";
                } else {
                    alert('Ada masalah dalam pengiriman form');
                }
            })
            .catch(error => {
