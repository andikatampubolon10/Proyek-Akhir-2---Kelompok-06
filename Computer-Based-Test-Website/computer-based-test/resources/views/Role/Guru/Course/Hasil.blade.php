    ...
    <div class="flex flex-col h-screen">
        ...
        <div class="flex flex-1 flex-col md:flex-row">
            ...
            <div class="flex-1 p-4">
                <div class="border border-gray-300 p-4 bg-white shadow-md">
                    <h1 class="text-4xl font-bold mb-4">Ilmu Pengetahuan Alam</h1>
                </div>
                <div class="border border-gray-300 mt-4 p-4 bg-white shadow-md">
                    <div class="flex justify-between items-center mb-4">
                        <a href="#" class="custom-link">Quiz 1 Sistem Pencernaan</a>
                        <div class="relative dropdown" id="dropdown">
                            <i class="fas fa-cog cursor-pointer" onclick="toggleDropdown()"></i>
                            <div class="dropdown-menu absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg">
                                <a class="block px-4 py-2 text-gray-800 hover:bg-gray-100" href="#">Export to Excel</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="min-w-full border-collapse border border-gray-300">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border border-gray-300 px-4 py-2 text-left font-bold">Grade</th>
                                    <th class="border border-gray-300 px-4 py-2 text-left font-bold">State</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="border border-gray-300 px-4 py-2">Natan Obet Nego Hutahean</td>
                                    <td class="border border-gray-300 px-4 py-2">100</td>
                                    <td class="border border-gray-300 px-4 py-2">Finished</td>
                                </tr>
                                <tr>
                                    <td class="border border-gray-300 px-4 py-2">Natan Obet Nego Hutahean</td>
                                    <td class="border border-gray-300 px-4 py-2">100</td>
