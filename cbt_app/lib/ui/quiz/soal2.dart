...
class Soal2Screen extends StatelessWidget {
        ...
        child: Stack(
          children: [
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Soal 2', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.grey)),
                ...
                const SizedBox(height: 16),
                Image.asset('assets/images/soal.jpg'),
