...
class _HomeDetailScreenState extends State<HomeDetailScreen> {
  ...
  Future<Map<String, dynamic>> fetchKursusData(String idKursus) async {
    var url = Uri.parse('http://192.168.190.78:8080/kursus/$idKursus'); // API endpoint for kursus
  ...
  Future<List<Map<String, dynamic>>> fetchData(String idKursus) async {
    ...
    var url = Uri.parse('http://192.168.190.78:8080/ujian-materi-kursus/$idKursus'); // Example URL
